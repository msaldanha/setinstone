...
func (m *MockIterator) Next(ctx context.Context) (GraphNode, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Next", ctx)
	ret0, _ := ret[0].(GraphNode)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGraph) Get(ctx context.Context, key string) (GraphNode, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockGraph) Append(ctx context.Context, keyRoot string, node NodeData) (GraphNode, error) {
	m.ctrl.T.Helper()
...
func (m *MockGraph) GetIterator(ctx context.Context, keyRoot, branch, from string) (Iterator, error) {
	m.ctrl.T.Helper()
